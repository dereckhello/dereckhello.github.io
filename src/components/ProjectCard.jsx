...
function ProjectCard({type, title, technologies, firstImg }) {
  ...
  return (
    <div onClick={() => {goToPage(type,title)}} className="bg-gray-50 p-4 rounded-lg w-full cursor-pointer 
      ...
      <img src={firstImg} className='rounded w-full h-35 object-cover' loading="lazy"/>
    </div>
  );
}
